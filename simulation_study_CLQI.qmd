...
imputation_algorithm <- function(basis_coefficients, study_for_imputation, 
  ...
  min_imp <- 0
  max_imp <- as.numeric(quantile(study_for_imputation$confounder_1, 0.99)) #only go up to the 99th quantile for our data
...
sim_setting_1_results <- repetera_full_simulation(specified_sample_size = 2500, 
                                                 specified_tau = 0, 
