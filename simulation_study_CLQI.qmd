...
We will be defining some more functions before running Simulation 1
...
`find_prop_missing` finds the proportion of LD data for the missing study. This will end up being useful
...
*Don't use confounder 1*: super terrible, even worse than complete case
