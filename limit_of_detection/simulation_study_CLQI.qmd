...
Now we should make sure that the data generating mechanism works as promised: we will generate data and do logistic regression after extracting true coefficients to ensure everything looks right.
