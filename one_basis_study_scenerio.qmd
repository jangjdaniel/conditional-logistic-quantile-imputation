...
```{r}
uniform_values <- function(prop_missing = 99) {
...
The function to implement the case above... AHHHHHHHHHH

```{r}
max(missing_study$confounder_1)

#not entirely sure how i want to build this up
CLQI <- function(basis_coefficients, study_for_imputation, 
  ...
  #THIS IS THE ISSUE...
  max_imp <- 15
  temp <- as.numeric(quantile(missing_study$confounder_1, missing_data_proportion))
  #then normal distribution to add random error... AHHHHHHH
