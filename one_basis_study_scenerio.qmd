...
missing_study <- missing_study |>
  mutate(confounder_1_constant_imputed = ifelse(is.na(confounder_1_missing), 0.912/sqrt(2), confounder_1_missing))
...
missing_study <- missing_study |>
  mutate(confounder_1_constant_imputed_2 = ifelse(is.na(confounder_1_missing), 0.912/2, confounder_1_missing))
...
bias_results <- sim_results$bias
MSE_results <- sim_results$MSE
