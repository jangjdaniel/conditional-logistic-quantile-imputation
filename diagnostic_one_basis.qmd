...
uniform_values <- function(prop_missing) {
  u <- runif(1, min = 1, max = prop_missing)
...
CLQI <- function(basis_coefficients, study_for_imputation, 
  ...
  #what is the LD quantile?
  LD_quantile <- find_prop_missing(missing_data_study = study_for_imputation, LD = var_for_imputation)
...
odds_b1 #should be biased... (moreso than our algorithm)
```

```{r}
#complete case analysis cus why not
