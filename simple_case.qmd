...
tictoc::tic()
num_sim <- 1000 #1000 simulations cus why not
...
#quick bias checks
mean(simulations$estimate_values_CLQI) - log(1.1)
mean(simulations$estimate_values_PMM) - log(1.1)
